...
const Navbar = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full h-auto flex justify-between items-center p-5 z-9999 bg-transparent
    ...
    >
      ...
      <button
        className="px-5 py-1 border border-pink-300/40 rounded-3xl uppercase font-light text-pink-200 tracking-widest 
      md:text-[.9rem]"
      >
        resume
      </button>
